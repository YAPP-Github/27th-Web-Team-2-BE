...
sealed class AuthException(code: String, message: String, messageForDev: String? = null, cause: Throwable? = null) : NoMoneyException(code, message, messageForDev, cause)

class UnauthorizedException(messageForDev: String? = null) : AuthException("TOKEN_INVALID", "인증을 실패했습니다.", messageForDev)
class NotFoundTokenException(messageForDev: String? = null) : AuthException("TOKEN_NOT_EXIST", "인증을 실패했습니다.", messageForDev)
